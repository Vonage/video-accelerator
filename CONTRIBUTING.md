...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/video-accelerator.git

**All changes should be based from the `main` branch.**

Push to your fork and [submit a pull request](https://github.com/vonage/video-accelerator/compare/) against the `main` branch.
